...
(()=>{
    ...
    (()=>{
        ...
        var suggestpick_A = {'first': ['rouie','zata','lorion','annette','iggy','mganga','stuart','hayate','violet','elsu','elandorr','fennik','wisp','capheny','biron','marja','skud','qi','riktor','ryoma','mina','sinestrea','tachi','zephys','billow','elandorr','keera','volkath','edras','taara','dolia','dyadia','teemee','ybneth','enzo','thane','toro'],'second':['ignis','gildur','heino','yue','liliana','natalya','aya','sephera','valhein','moren','telannas','florentino','airi','yena','omen','murad','errol','nakroth','zuka','kriknak','helen','ming','cresht','wiro'],'third': ['diaochan','azzenka','kahlii','krixi','jinna','goverra','raz','lauriel','tulen','thorne','laville','teeri','slimz','maloch','kilgroth','roxie','charlotte','boltbarron','zanis','zuka','lubu','veres','superman','aoi','wonderwoman','baldum','zip','lumburr','omega',],'fourth':['aleister','alice','bonnie','erin','dirak','ilumia','preyta','veera','celica','lindis','bijan','ata','arduin','billow','kaine','max','xeniel','yan','volkath','butterfly','zill','rourke','arum','chaugnar','grakk'],'fifth': ['ishar','bright','yorn','allain','amily','astrid','dextra','wukong','mortos','quillen','kaine','paine','darcy','ormarr']};
