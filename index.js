...
(()=>{
    ...
    (()=>{
        ...
        var suggestpick_A = {'first': ['billow','tachi','heino','zephys','valhein','annette','raz','ming','dolia','maloch','hayate','stuart','qi','marja','enzo','elandorr','capheny','teemee','rouie','keera','florentino','yena','lorion','wisp','skud'],'second':['riktor','boltbarron','biron','ignis','krizzix','helen','xeniel','zip','thane','aoi','kriknak','fennik','violet','arduin','toro','omen','ryoma','murad','mina','mganga','liliana','dirak','yue','natalya'],'third': ['elsu','baldum','grakk','ybneth','omega','nakroth','sephera','zuka','wonderwoman','telannas','errol','rourke','airi','charlotte','iggy','zata','teeri','slimz','diaochan','aleister','roxie','bijan'],'fourth':['tulen','dextra','yan','cresht','arum','alice','zill','lubu','krixi','sinestrea','veres','zanis','laville','ilumia','lumburr','lauriel','aya'],'fifth': ['bright','mortos','erin','superman','preyta','kaine']};
